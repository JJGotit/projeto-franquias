...
function Funcionarios() {
    ...
    async function carregarFuncionarios() {
        try {
            setLoading(true)
            //const response = await fetch('/api/funcionarios')     // api interna
            //const response = await fetch('https://franq.megamaximo.com.br/?funcionario') // api externa
            const response = await fetch('https://localhost/?funcionario') // api localhost
